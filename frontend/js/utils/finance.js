    ...
    quant: {
      ...
      summaryStatistics: function (arr) {
        ...
        return {
          ...
          p001: arr[Math.floor(arr.length * 0.001)],
          p01: arr[Math.floor(arr.length * 0.01)],
          p05: arr[Math.floor(arr.length * 0.05)],
          ...
          q90: arr[Math.ceil(arr.length * 0.90)],
          p95: arr[Math.floor(arr.length * 0.95)],
          p99: arr[Math.floor(arr.length * 0.99)],
          p999: arr[Math.floor(arr.length * 0.999)],
        };
      },

    ...
    return (
      <div className={"blog housing-blog " + (this.state.readerType === "Expanded" ? "blog--expanded" : "blog--expert")}>
        ...
        <article>
          ...
          <section>
            <p>You clicked this link knowing in your mind that this isn’t true. House prices are high, you can see it everywhere you look. Reporters and everyday Americans alike can recite statistics and recount personal experiences detailing how inaccessible real estate is to homebuyers today. Living in the Bay Area, it’s a day ending in “–day” when you hear a story about a middle class family who purchased a home back in the ‘80s in Palo Alto that is now worth a cool two million dollars.</p>
            <p>The data and the stories support the worldview that home prices are more expensive than ever, and in the purest sense that’s absolutely true. In a practical sense it’s incredibly false. This is because <strong>people don’t typically buy houses, they get mortgages.</strong></p>
          ...
          <section>
            ...
            <p>The chart becomes a lot more reasonable when adjusting for inflation and adjusting for increases in income, below we show the price of a house as a factor of <i>median income</i> from 1980–2020, but there’s still a notable increase in housing prices over the past forty years — and here is also where the analysis usually stops, and most people go home thinking that they’ll never be able to afford the kinds of homes their parents grew up in.</p>
          </section>
          <div className="center">
            <div className="figure figure--article-width inline-block">
          ...
          <section>
            ...
            <p>Multiplying our adjusted home prices to the dramatically cheaper cost of financing, shows the real picture: home prices are actually more affordable than ever. There have been upward and downward swings before in price — run-ups like the one leading to the 2008 Financial Crisis are still evident, yet still well below prices experienced in the early 1980s by homebuyers financing through a mortgage.</p>
          </section>
          <div className="center">
            <div className="figure figure--article-width inline-block">
          ...
          <section>
            ...
            <p>America leads the world in home sizes. Like a goldfish, American houses have continued to grow to fit their tank. As the suburbs have continued to expand, homes in the United States have swelled past 2,500 square feet in size, almost double the size of the average home in Germany and France, both countries with similar purchasing power.</p>

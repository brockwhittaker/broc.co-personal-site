  ...
  calculateForExpiry (exp) {
    ...
    fetch(`/api/${this.state.ticker}/options/${exp}/`).then(r => r.json()).then(data => {
      ...
      chart({ container: this.chart, series: [{
        ...
        data: calls,
        color: 'transparent'
      }], title: `${this.state.ticker} Price Predictions at Year End`, subtitle: `Market outcomes expressed as betting odds, calculated through live options premiums retrieved from Robinhood.`, xAxisMin: calls[calls.length - 1].x, xAxisDividingIndex: +calls[calls_max_index].strikes[0].strike_price });
/*
    ...
    return (
      <>
        ...
        <article>
          ...
          <h2>A Special Primer on Options Pricing</h2>
          <section>
          ...
          <h2>A Brief Primer on Call Options</h2>
          <section>
          ...
          <h2>An Even Briefer Primer on Black-Scholes</h2>
          <section>
          ...
          <h2>Options Under a Microscope</h2>
          <section>
            <p>If you look at the options chain for any stock you'll notice you can purchase options at many price points. For SPY (a Standard & Poor 500 tracking ETF) options expiring July 31st, you can purchase options at strikes at every $1 interval for many price points.</p>
            <p>However, how do we more quantitatively look at options prices to find what the market expects prices will be? We can do this by taking the difference of premium between two strikes to get a relative probability of being above or below a price at expiration.</p>
            <p>For example, look at the two theoretical call options available for purchase below:</p>
            <div className="center">
            ...
            <p>Let's look at the strikes and premiums of the two highlighted options above: a $325 call with a premium of $2.22, and a $324 call with a premium of $2.50.</p>
            <p>The call with a strike at $324 is worth more, because in the case that Apple closes at $325 a share, the $324 call is worth $1 and the $315 call is worth nothing.</p>
            <p>In the above calculated column, we can see that the $324 call is being traded for $0.28 more than the $325 call. That means the market assesses the potential value of the extra dollar of profit at 28 cents on the dollar. Stated in other words, the market thinks there is about a 28% chance that SPY will reach $325 per share — in which case the $324 option will be worth $1 more than the $325 option, rather than worth nothing.</p>
            <p>You can note in the above table that the option premiums reflect the odds you'd expect to see with SPY being at $312.65 right now: the chance of rising to $321 is 40%, but the chance of rising to $325 is a significantly smaller 28%.</p>
            <p>If we want to find the price that SPY is expected on average to land at on 07/31, we would want to find the two options where the change in premium is ~ -$0.50 to the next strike.</p>
            <div className="center">
              <div className="figure figure--chart inline-block">
                <div className="figure--text"><b>Fig 4.</b> SPY Options Chain (07/31)</div>
                <table>
                  <thead>
                    <tr>
                      <th className="strike">Strike</th>
            ...
            <p>If we express these percentages as betting odds, the odds of SPY being higher than $317 on 07/31 is 1:1, and the odds of it being higher than $325 is 1:2.57.</p>
            <div className="center">
              <div className="figure figure--full-width inline-block">
                <div className="figure--text"><b>Fig 5.</b> Betting odds on SPY price across all strikes (07/31)</div>
          ...
          <section>
            ...
            <blockquote>Find the future expected price of a stock on a given date.</blockquote>
            ...
            <p className="quote-description">The first two are pretty straightforward, the third is best explained with the below diagram.</p>
            <div className="center quote-description">
              <div className="figure figure--full-width inline-block">
                <div className="figure--text"><b>Fig 6.</b> Positive and Negative Skews</div>
